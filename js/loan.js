...
function doBalance () {
    ...
    document.getElementById('output2').innerHTML = computeBalance (principal, intRate,  numPMT);
}

function computeBalance (a, r, d,) {
...
b = (a * (1 + (r/12))**d) - a * (r/n) / (1 - ((1 + (r/n))**(-n*y))) * (( 1 + (r/12))**d - 1) / (r/12);
